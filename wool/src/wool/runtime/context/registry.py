"""Shared :class:`ContextVar` registry, factored out so :mod:`base`,
:mod:`stub`, and :mod:`var` can import it without forming a cycle."""
...
# state — see :meth:`ContextVar.__new__` and :func:`resolve_stub`.
