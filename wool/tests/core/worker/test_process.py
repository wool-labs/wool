...
from wool.core.worker.process import _proxy_factory
from wool.core.worker.process import _proxy_finalizer
from wool.core.worker.process import _sigint_handler
from wool.core.worker.process import _signal_handlers
from wool.core.worker.process import _sigterm_handler
...
class TestSignalHandlers:
    ...
    def test__sigterm_handler_calls_service_stop_when_loop_is_running(self, mocker):
        ...
        mocker.patch(
            "wool.core.worker.process.pb.worker.StopRequest",
...
class TestWorkerProcess:
    ...
    def test_start_calls_parent_start(self, mocker):
        ...
        mocker.patch(
            "wool.core.worker.process.Pipe", return_value=(mock_get_port, mock_set_port)
        )
    ...
    def test_run_sets_up_proxy_pool_and_starts_server(self, mocker):
        ...
        mocker.patch("wool.core.worker.process.wool.__proxy_pool__", mock_proxy_pool)

        mock_resource_pool = mocker.MagicMock()
        mock_resource_pool_class = mocker.patch(
            "wool.core.worker.process.ResourcePool", return_value=mock_resource_pool
        )
        ...
        mocker.patch("wool.core.worker.process.WorkerService", return_value=mock_service)

        # Mock signal handlers
        mocker.patch("wool.core.worker.process._signal_handlers")
    ...
    def test_run_sends_port_through_pipe(self, mocker):
        ...
        # Mock infrastructure
        mocker.patch("wool.core.worker.process.wool.__proxy_pool__")
        mocker.patch("wool.core.worker.process.ResourcePool")
