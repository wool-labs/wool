...
from wool.core.discovery.lan import _deserialize_worker_info
from wool.core.discovery.lan import _serialize_worker_info
...
class TestLanDiscovery:
    ...
    Fully qualified name: wool.core.discovery.lan.LanDiscovery
    """
...
class TestLanDiscoveryPublisher:
    ...
    Fully qualified name: wool.core.discovery.lan.LanDiscovery.Publisher
    """
...
class TestLanDiscoverySubscriber:
    ...
    Fully qualified name: wool.core.discovery.lan.LanDiscovery.Subscriber
    """
    ...
    async def test_subscriber_handles_update_deserialization_error(self, mocker):
        ...
        mocker.patch(
            "wool.core.discovery.lan._deserialize_worker_info",
...
class TestSerializationFunctions:
    ...
    Fully qualified name: wool.core.discovery.lan
    """
