...
from wool.core.discovery.local import NULL_REF
from wool.core.discovery.local import LocalDiscovery
from wool.core.discovery.local import _lock
from wool.core.discovery.local import _shared_memory
from wool.core.discovery.local import _short_hash
from wool.core.discovery.local import _Watchdog
from wool.core.discovery.local import _watchdog_path
from wool.core.discovery.local import _WorkerReference
...
class TestSharedMemory:
    ...
    Fully qualified name: wool.core.discovery.local._shared_memory
    """
...
class TestLock:
    ...
    Fully qualified name: wool.core.discovery.local._lock
    """
...
class TestWatchdog:
    ...
    Fully qualified name: wool.core.discovery.local._Watchdog
    """
...
class TestLocalDiscoveryPublisher:
    ...
    async def test_publish_with_none_buf_raises_error(
        ...
        async with publisher:
            ...
            with mocker.patch(
                "wool.core.discovery.local._shared_memory",
    ...
    async def test_update_restores_prior_state_on_exception(
        ...
        try:
            async with publisher:
                ...
                with mocker.patch(
                    "wool.core.discovery.local.struct.pack_into",
