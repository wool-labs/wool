...
class TestCallbackValuePropagationParity:
    @pytest.mark.asyncio
    async def test_callback_should_propagate_scoped_value(self, scheduler, make_var):
    ...
    @pytest.mark.asyncio
    async def test_callback_should_observe_registration_time_value(
    ...
    @pytest.mark.asyncio
    async def test_callback_should_preserve_scope_chain(self, scheduler):
    ...
    @pytest.mark.asyncio
    async def test_callback_set_should_not_leak_to_scheduling_scope(
        self, scheduler, make_var
    ):
    ...
    @pytest.mark.asyncio
    async def test_callback_lookup_error_should_surface_on_future(
        self, scheduler, make_var
    ):
...
class TestCallSoonThreadsafeParity:
    @pytest.mark.asyncio
    async def test_call_soon_threadsafe_should_observe_fallback_when_from_foreign_thread(
        self, make_var
    ):
        """Test call_soon_threadsafe does not capture the loop thread's context.
    ...
    @pytest.mark.asyncio
    async def test_call_soon_threadsafe_should_observe_value_when_from_setting_thread(
        self, make_var
    ):
