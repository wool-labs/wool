...
class TestNamespaceIsolation:
    """Tests for WorkTask namespace parameter and namespace isolation."""

    # NS-001: Default namespace=None when not specified
    def test_default_namespace_none(self, sample_task, clear_event_handlers):
        """Test WorkTask defaults namespace to None.

        Given:
            A WorkTask created without specifying namespace
        When:
            WorkTask is instantiated
        Then:
    ...
    def test_explicit_namespace_none(self, sample_task, clear_event_handlers):
        """Test WorkTask with explicit namespace=None.

        Given:
            A WorkTask created with namespace=None
        When:
            WorkTask is instantiated
        Then:
    ...
    def test_explicit_namespace_worker(self, sample_task, clear_event_handlers):
        """Test WorkTask with namespace=WORKER.

        Given:
            A WorkTask created with namespace=WORKER
        When:
            WorkTask is instantiated
        Then:
    ...
    def test_explicit_named_namespace(self, sample_task, clear_event_handlers):
        """Test WorkTask with explicit named namespace.

        Given:
            A WorkTask created with namespace="cache"
        When:
            WorkTask is instantiated
        Then:
    ...
    async def test_isolation_coroutine_globals_not_visible(
        ...
        Given:
            A WorkTask with namespace=None (default)
        When:
    ...
    async def test_worker_namespace_coroutine_globals_persist(
        ...
        Given:
            A WorkTask with namespace=WORKER
        When:
            The callable sets a global variable
        Then:
    ...
    async def test_isolation_async_generator_globals_not_visible(
        ...
        Given:
            A WorkTask with async generator callable and namespace=None
        When:
            The callable sets a global variable
        Then:
            The global variable is not visible in the original namespace
    ...
    async def test_worker_namespace_async_generator_globals_persist(
        ...
        Given:
            A WorkTask with async generator callable and namespace=WORKER
        When:
            The callable sets a global variable
        Then:
            The global variable is visible in the original namespace
    ...
    async def test_read_through_module_imports_accessible(
        ...
        Given:
            A WorkTask with namespace=None
        When:
    ...
    async def test_closure_variables_preserved_with_isolation(
        ...
        Given:
            A WorkTask with namespace=None and a callable with closure
        When:
    ...
    async def test_from_protobuf_with_namespace(
        ...
        When:
            from_protobuf is called
        Then:
            The deserialized WorkTask has namespace="cache"
        """
        # Arrange
        task_id = uuid4()
        pb_task = pb.task.Task(
    ...
    async def test_from_protobuf_with_worker_namespace(
        ...
        When:
            from_protobuf is called
        Then:
            The deserialized WorkTask has namespace=WORKER
        """
        from wool.runtime.work.task import WORKER
    ...
    async def test_from_protobuf_defaults_none_when_absent(
        ...
        When:
            from_protobuf is called
        Then:
            The deserialized WorkTask has namespace=None (default)
        """
        # Arrange
        task_id = uuid4()
        pb_task = pb.task.Task(
    ...
    def test_to_protobuf_serializes_namespace(
        ...
        Given:
            A WorkTask with namespace="cache"
        When:
            to_protobuf is called
        Then:
    ...
    async def test_mutable_object_mutation_visible(
        ...
        Given:
            A WorkTask with namespace=None accessing a mutable global
        When:
    ...
    async def test_isolation_through_nested_function_calls(
        ...
        Given:
            A WorkTask with namespace=None calling a nested function
        When:
    ...
    async def test_isolation_maintained_on_exception(
        ...
        Given:
            A WorkTask with namespace=None that raises an exception
        When:
    ...
    async def test_isolation_maintained_on_cancellation(
        ...
        Given:
            A WorkTask with namespace=None that gets cancelled
        When:
    ...
    async def test_different_namespaces_isolated(
        ...
        Given:
            Two WorkTasks with different namespaces
        When:
    ...
    async def test_serialization_roundtrip_preserves_namespace(
        ...
        Given:
            A WorkTask with any namespace value
        When:
