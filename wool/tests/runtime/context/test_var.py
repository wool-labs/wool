...
# adoption path on first :meth:`ContextVar.set`.
...
class TestContextVar:
    ...
    def test_reset_should_raise_value_error_when_token_for_different_var(self):
        ...
        Then:
            ...
            :class:`ValueError` naming the different ContextVar.
        """
        # Arrange
    ...
    def test_reset_should_raise_type_error_when_argument_not_token(self, not_a_token):
        ...
        Then:
            Stdlib's :meth:`contextvars.ContextVar.reset` raises
            :class:`TypeError` naming Token — the type check guards
    ...
    def test_reset_should_raise_runtime_error_when_used_token_for_different_var(self):
        ...
        Then:
            Stdlib's :meth:`contextvars.ContextVar.reset` raises
            :class:`RuntimeError` for the used token — the used-token
