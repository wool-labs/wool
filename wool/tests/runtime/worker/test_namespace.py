...
@pytest.mark.asyncio
async def test_activate_binds_context_id_visible_via_current_context():
...
@pytest.mark.asyncio
async def test_activate_restores_context_id_on_exit():
...
@pytest.mark.asyncio
async def test_activate_child_task_forks_with_fresh_id():
...
def test_activate_without_running_task_binds_context_id_for_sync_caller():
...
@pytest.mark.asyncio
async def test_activate_restores_context_id_on_exception():
...
@pytest.mark.asyncio
async def test_activate_nested_restores_outer_context_id():
...
@pytest.mark.asyncio
async def test_activate_creates_empty_context_for_block():
...
@pytest.mark.asyncio
async def test_activate_vars_set_inside_do_not_leak_outside():
...
@pytest.mark.asyncio
async def test_activate_var_set_inside_visible_to_child_task():
